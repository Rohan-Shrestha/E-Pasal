            ...
            <header class="clearfix">
                <div class="container">
                    <div class="company-address">
                        <h2 class="title">E-PASAL ONLINE STORE</h2>
                        <p>
                            Dilibazaar, Kathmandu,<br>
                            44605, Nepal
                        </p>
                    </div>
                    <div class="company-contact">
                        ...
                        <div class="email right">
                            ...
                            <a href="mailto:rohanstha232@gmail.com">rohanstha232@gmail.com</a>
                            <span class="helper"></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="details clearfix">
                        <div class="client left">
                            ...
                            <p>'.$orderDetails['address'].', '.$orderDetails['city'].', '.$orderDetails['province'].', '.$orderDetails['country'].' - '.$orderDetails['pincode'].'</p>
                        ...
                        <div class="data right">
                            ...
                            <div class="date">
                                ...
                                Order Amount: Rs. '.$orderDetails['grand_total'].'<br>
                                Order Amount: '.$orderDetails['order_status'].'<br>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    if($orderDetails['coupon_amount']>0){
                                        $invoiceHTML .= '<td class="total">Rs. '.$orderDetails['coupon_amount'].'</td>';
                                    } else {
                                        $invoiceHTML .= '<td class="total">Rs. 0</td>';
                                    }
                                $invoiceHTML .= '</tr>
                                <tr>
                                    <td class="desc"></td>
