    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-9 col-sm-12">
                    ...
                    <div class="toolbar-sorter">
                        <div class="select-box-wrapper">
                            ...
                            <select name="sort" id="sort" class="select-box">
                                ...
                                <option value="name_z_a" @if(isset($_GET['sort']) && $_GET['sort']=="name_z_a") selected="" @endif>Sort >Sort By: Name Z - A</option>
                ...
                <!-- Row-of-Product-Container /- -->
                @if(isset($_GET['sort']))
                    <div class="mb-3 pb-3">{{ $categoryProducts->appends(['sort'=>$_GET['sort']])->links() }}</div>
                @else
                    <div class="mb-3 pb-3">{{ $categoryProducts->links() }}</div>
                @endif
