        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-9 col-sm-12">
                ...
                <div class="page-bar clearfix">
                    ...
                    <!-- Toolbar Sorter 1  -->
                    <?php /*<form name="sortProducts" id="sortProducts" action="">
                ...
                <!-- Row-of-Product-Container /- -->
                @if(isset($_GET['sort']))
                <div class="mb-3 pb-3">{{ $vendorProducts->appends(['sort'=>$_GET['sort']])->links() }}</div>
                @else
                <div class="mb-3 pb-3">{{ $vendorProducts->links() }}</div>
                @endif
            </div>
            <!-- Shop-Right-Wrapper /- -->
            <!-- Shop-Pagination -->
