...
<body>
    <table style="width: 700px;">
        ...
        <tr><td>&nbsp;</td></tr>
        <tr><td>One of your Ordered #{{ $order_id }} Item Status has been updated to {{ $order_status }}</td></tr>
        <tr><td>&nbsp;</td></tr>
        @if(!empty($courier_name) && !empty($tracking_number))
            <tr><td>
                Courier Name: {{ $courier_name }} and Tracking Number: {{ $tracking_number }}
            </td></tr>
            <tr><td>&nbsp;</td></tr>
        @endif
        <tr><td>Your Ordered Item Details are as below:</td></tr>
        <tr><td>&nbsp;</td></tr>
        <tr>
            <td>
