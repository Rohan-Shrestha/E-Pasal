            ...
            <div class="row">
                ...
                <div class="col-xs-6 text-right">
                    <address>
                        ...
                        {{ $orderDetails['city'] }}, {{ $orderDetails['province'] }}<br>
                            ...
                            <tbody>
                                ...
                                @foreach ($orderDetails['orders_products'] as $product)
                                    <tr>
                                        ...
                                        <td class="text-left">{{ $product['product_qty'] }}</td>
                                ...
                                <tr>
                                    ...
                                    <td class="no-line"></td>
                                    <td class="no-line"></td>
                                    <td class="no-line text-right"><strong>Net Total</strong></td>
                                    <td class="no-line text-right">
                                        <strong>Rs. {{ $orderDetails['grand_total'] }}</strong><br>
                                        @if($orderDetails['payment_method']=="COD")
                                            <p class="text-primary"><strong>(Already Paid)</strong></p>
                                        @endif
                                    </td>
                                </tr>
                            </tbody>
